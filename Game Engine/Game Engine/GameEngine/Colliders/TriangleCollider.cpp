#include "TriangleCollider.hpp"
#include <iostream>

TriangleCollider::TriangleCollider(Transform* transform, bool isMovable)
{
  this->transform = transform;
  this->isMovable = isMovable;
}

bool TriangleCollider::IsMovable()
{
  return isMovable;
}


std::vector<glm::vec3> TriangleCollider::GetVertices()
{
  // 1 - Get vertices
  auto vertices = Triangle::verticeBuffer;
...
glm::vec3 TriangleCollider::GetCenter()
{
  return this->transform->position;
}

glm::vec3 TriangleCollider::GetFurtherVertexInDir(glm::vec3 d)
{
  // 1 - Get vertices
  auto vertices = Triangle::verticeBuffer;
